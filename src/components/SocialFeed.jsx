...
//             <div key={post.id} className="relative w-[300px] h-[300px] rounded-xl overflow-hidden group">
//               {post.type === "image" ? <Image src={post.image || "/placeholder.svg"} alt={post.alt} fill className="object-cover transition-transform duration-500 group-hover:scale-110" /> : <video src={post.image || "/placeholder.svg"} alt={post.alt} className="object-cover transition-transform duration-500 group-hover:scale-110 w-full h-full" loop muted autoPlay />}
//               {post.href && (
...
//           <a href="https://instagram.com/kolkatachaico" target="_blank" rel="noopener noreferrer">
//             FOLLOW US
//           </a>
//         </Button>
//       </div>
